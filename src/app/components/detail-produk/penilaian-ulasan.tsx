...
const PenilaianUlasan = () => {
  const [like, setLike] = useState("stroke-[#2a2a2a]");

  const handleLike = (e: any) => {
    e.preventDefault();

    if (like == "stroke-[#2a2a2a]") {
      setLike("stroke-red-400");
    } else {
      setLike("stroke-[#2a2a2a]");
    }
  };

  return (
    <>
      <div className="border-y-[6px] border-[#f1f1f1] p-5">
        ...
        <div className="mt-[4px] gap-[10px] flex items-center w-full">
          <div className="flex gap-2 items-center ">
            ...
            <h1 className="font-nunito font-bold text-[10px]">4.8</h1>
          </div>

          <p className="text-[#949494] text-[10px]">32 Rating</p>

          <p className="text-[#949494] text-[10px]">26 Ulasan</p>
        </div>
